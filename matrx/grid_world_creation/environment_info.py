...
from matrx.agents.llm.modules.agent_infra.perception_module import precompute_all_areas
...
class EnvironmentInformation:
    ...
    def get_area_cells(self) -> Dict[str, frozenset[Tuple[int, int]]]:
        """Return mapping from area name to inside cells (for Perception.init_area_tracker)."""
